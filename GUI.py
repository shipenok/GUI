...
def toggle_selector_2(event):
    print(' Key pressed.')
    if event.key == '2':
        if toggle_selector_2.RS.active:
            print(' RectangleSelector deactivated.')
            toggle_selector_2.RS.set_active(False)
        else:
            print(' RectangleSelector activated.')
            toggle_selector_2.RS.set_active(True)
...
toggle_selector_2.RS = RectangleSelector(current_ax, line_select_callback,
                                       drawtype='box', useblit=True,
                                       button=[1, 3],
                                       minspanx=5, minspany=5,
                                       spancoords='pixels',
...
plt.connect('key_press_event', toggle_selector_2)
plt.show()
